...
const COPY: Record<string, Copy> = {
  en: {
    ...
    s1Title: 'Who is responsible for this',
    ...
    s2Title: 'Editorial standards',
    s2Body: "Every article is produced under a detailed set of written editorial rules and is only published once it passes a set of automated checks. Those checks include:",
    ...
    s5Body: "Loadly currently publishes roughly one new article per weekday, and each one passes the checks above before it goes live.",
  ...
  tr: {
    ...
    s2Title: 'Editoryal standartlar',
    s2Body: "Her makale, yazılı ve detaylı editoryal kurallar altında hazırlanır ve yalnızca bir dizi otomatik kontrolden geçtikten sonra yayınlanır. Bu kontroller şunları içerir:",
    ...
    s5Body: "Loadly şu anda hafta içi her gün yaklaşık bir yeni makale yayınlıyor ve her biri yayına girmeden önce yukarıdaki kontrollerden geçiyor.",
