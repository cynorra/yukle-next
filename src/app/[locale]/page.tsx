...
const HOME_FAQS: Record<string, { title: string; items: { q: string; a: string }[] }> = {
  ...
  en: {
    ...
    items: [
      { q: 'What is Loadly?', a: 'Loadly is a content platform publishing practical guides, industry analysis, and news for the logistics and freight sector.' },
...
export default async function HomePage({ params }: PageProps) {
  ...
  return (
    ...
    <div className="min-h-screen bg-background-light dark:bg-background-dark selection:bg-accent/30">
      ...
      {/* Site-wide footer now rendered once in layout.tsx */}
