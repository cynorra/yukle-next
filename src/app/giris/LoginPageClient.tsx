                ...
                {resetSent ? (
                  <div className="text-center py-4">
                    ...
                    <button
                      ...
                      className={`w-full py-3 rounded-xl font-bold text-sm ${t.btnPrimary}`}
                    >
                      Giriş Sayfasına Dön
                    </button>
                  </div>
                  ...
                  <form onSubmit={handleReset} className="space-y-4">
                    ...
                    <button type="submit" disabled={resetLoading}
                      className={`w-full py-3.5 rounded-xl font-bold text-sm disabled:opacity-50 flex items-center justify-center gap-2 ${t.btnPrimary}`}>
                      {resetLoading ? <><Loader2 size={16} className="animate-spin" />Gönderiliyor...</> : 'Bağlantı Gönder'}
                    </button>
                    <button type="button" onClick={() => setShowReset(false)}
                      className={`w-full py-3.5 rounded-xl font-medium text-sm ${t.btnSecondary}`}>
                      ← Geri Dön
                    </button>
                  </form>
                )}
