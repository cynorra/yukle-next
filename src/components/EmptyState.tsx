    ...
    >
      ...
      {action && (
        <button
          ...
          className={`flex items-center gap-2 px-8 py-3 rounded-2xl font-black text-sm shadow-lg shadow-accent/20 hover:shadow-accent/40 hover:-translate-y-0.5 active:translate-y-0 transition-all ${t.btnPrimary}`}
        >
