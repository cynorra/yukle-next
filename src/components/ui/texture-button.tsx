...
const buttonVariantsOuter = cva("", {
  variants: {
    variant: {
      ...
      accent:
        "w-full border-[1px] dark:border-[2px] border-black/10 dark:border-neutral-950 bg-yellow-400 dark:bg-yellow-400 p-[1px] transition duration-300 ease-in-out ",
      destructive:
      ...
      secondary:
        "w-full border-[1px] dark:border-[2px] border-black/20 bg-neutral-100/80 dark:border-neutral-950 dark:bg-neutral-800 p-[1px] transition duration-300 ease-in-out ",
      minimal:
  ...
  "w-full h-full flex items-center justify-center text-muted-foreground",
  {
    variants: {
      variant: {
        ...
        accent:
          "gap-2 bg-yellow-400 text-sm text-neutral-900 font-bold transition duration-300 ease-in-out hover:bg-yellow-500 dark:hover:bg-yellow-500 active:bg-yellow-600 dark:active:bg-yellow-600",
        destructive:
        ...
        secondary:
          "bg-neutral-100/80 dark:bg-neutral-800 text-sm transition duration-300 ease-in-out hover:bg-neutral-200/80 dark:hover:bg-neutral-700 active:bg-neutral-300/80 dark:active:bg-neutral-600",
        minimal:
