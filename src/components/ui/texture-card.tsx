...
>(({ className, children, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "rounded-3xl border border-white/60 dark:border-border/30",
        className
      )}
      {...props}
    >
      <div className="border dark:border-neutral-900/80 border-black/10 rounded-[23px]">
        <div className="border dark:border-neutral-950 border-white/50 rounded-[22px]">
          <div className="border dark:border-neutral-900/70 border-neutral-950/20 rounded-[21px]">
            <div className=" w-full border border-white/50 dark:border-neutral-700/50 text-neutral-500 bg-gradient-to-b from-card/70 to-secondary/50 rounded-[20px] ">
              {children}
            </div>
          </div>
        </div>
