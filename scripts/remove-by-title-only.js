...
async function removeDuplicateBlogsByTitle() {
  ...
  for (const post of allPosts) {
    const key = post.title.trim().toLowerCase(); // Group strictly by title, ignoring case and whitespace
    if (seen.has(key)) {
